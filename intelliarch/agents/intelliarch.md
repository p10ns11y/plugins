...
pstack is Lauren Tan’s MIT plugin (https://github.com/cursor/plugins/tree/main/pstack). Load one playbook when it is installed. Do not vendor it.

`eva-emptiness` is `eva-emptiness/skills/eva-emptiness/SKILL.md` in this plugins repo. The skills-repo path is a sibling symlink and 404s on GitHub.
...
- Open every manifest path
- Copy pstack skills, playbooks, or poteto-mode into this repo
- Copy SKILL.md bodies from p10ns11y/skills into this repo
- Paste control-graph Outer or EVA Inner into this repo
- Pass `--always-approve` or `--yolo` on an empty route
